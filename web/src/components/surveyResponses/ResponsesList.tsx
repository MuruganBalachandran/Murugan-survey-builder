import type { Question, ResponsesListProps, SurveyResponse } from '@/types'
      ...
      {isEmpty ? (
        ...
        <div className="space-y-3">
          {responses.map((response, idx) => (
            <div
              key={response.id}
              className="rounded-xl border border-gray-200 p-4 transition-colors hover:border-violet-200 hover:bg-violet-50/50"
            >
